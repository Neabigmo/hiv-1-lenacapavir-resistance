...
# 6. H-bond N57 to ligand - PROMINENT SINGLE BOND
# N57 backbone N
...
# Select ONE specific ligand oxygen near N57 - the one that forms H-bond
# Use distance selection to find the nearest O atom
select nearby_ligand_o, resn QNG and elem O and (n57_n around 4)
# If multiple, just take the first one by proximity
distance hb1, n57_n, nearby_ligand_o, 4.0

# Make H-bond VERY prominent
set dash_color, green
set dash_width, 15.0
set dash_gap, 0.2
set dash_radius, 0.1
# Hide text label but keep the dash
hide label, hb1
