#!/usr/bin/env pymol
# Figure 4: Binding Site Detail - MINIMAL VERSION
...
# 3. Mutations - colored CA spheres
...
# 8. Zoom on binding site
zoom (chain A and resid 55-110) or resn QNG, 5
orient (chain A and resid 55-110) or resn QNG
