...
# 5. Ligand - YELLOW, only near chain A (not distant ligands)
select ligand_only, resn QNG and chain A around 8
...
# Find nearest ligand O atom near chain A
...
# 8. Zoom - INCLUDE ligand so H-bond is in view
