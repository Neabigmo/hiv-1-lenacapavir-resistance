...
# FINAL FIXED VERSION - Proper ligand and H-bond selection
...
############################################
# Ligand - CRITICAL FIX: Select by residue name QNG
# This correctly selects the ligand regardless of which chain it's on
############################################
...
# Show ligand as spheres for better visibility
show spheres, lig
color yellow, lig
...
############################################
# Hydrogen bond: N57 to ligand
# FIXED: No chain restriction on ligand atoms
############################################

# Show N57 backbone N as visible green sphere
select n57_n, resid 57 and name N and chain A
show spheres, n57_n
color green, n57_n
set sphere_scale, 0.35, n57_n

# Select ligand oxygen atoms WITHOUT chain restriction
select lig_o, (resn QNG and elem O)

# Also select nearby ligand atoms for better measurement
select lig_near_n57, (resn QNG around 4 and chain A around 8) or resn QNG

# Create distance between N57 N and nearest ligand O
distance hbond, n57_n, lig_o, 3.8

# Style the hydrogen bond - VERY prominent
