...
# 3. Mutations - colored spheres FIRST (so they show clearly)
...
# 4. Pocket - only chain A atoms, GRAY (after mutations so it doesn't override)
select pocket, chain A and resid 55-75
show sticks, pocket
color gray85, pocket
set stick_radius, 0.12

# 5. Ligand - YELLOW, only near chain A
# Correct syntax: resn QNG atoms that are within 8A of chain A
select ligand_only, resn QNG around 8
...
select nearby_ligand_o, resn QNG and elem O around 4
...
# 8. Zoom - include ligand
zoom (chain A and resid 55-110) or ligand_only, 5
orient (chain A and resid 55-110) or ligand_only
